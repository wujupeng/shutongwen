# ShuTongWen IME Build Script - Minimal Version (without external dependencies)

Write-Host "================================================"
Write-Host "Building ShuTongWen IME (Minimal Build)"
Write-Host "================================================"
Write-Host ""
...
# Source files to compile (only those without external dependencies)
$coreFiles = @(
    ...
    "src\platform\Win11Platform.cpp",
    "src\platform\caret\CaretLocator.cpp",
    "src\platform\caret\DpiTransformer.cpp",
    "src\platform\caret\WindowTracker.cpp",
    "src\platform\profiles\WindowProfile.cpp",
