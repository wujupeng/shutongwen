...
& cl /c /O2 /W3 /MT /I"$vcDir\include" installer.cpp
& link /OUT:ShuTongWenIME_Setup.exe installer.obj shlwapi.lib shell32.lib kernel32.lib user32.lib advapi32.lib /SUBSYSTEM:WINDOWS

if (Test-Path "ShuTongWenIME_Setup.exe") {
